...
int						is_protected(t_shell_control_block *sh, char *str,
							int index);
int						is_between_quotes(char *line, int index);
int						is_there_invalid_expantion(t_shell_control_block *sh,
							char *str, char *old_str);
...
char					*new_str_after_expand(t_shell_control_block *s,
							int num_of_expantion);
char					*get_env_var(t_shell_control_block *shell,
							t_expand data);
char					*buffering(char *s1, char *s2, char *s3);
char					*add_new_line(char *str);
char					*expnad_and_join_node(t_shell_control_block *s,
							t_expand data);
 ...
 *******************************************************************************/
void					rm_quotes_from_one_str(t_shell_control_block *sh,
							char **line);
void					rm_quotes_from_one_str_helper(t_shell_control_block *sh,
							char *line, char **parsed_quote_line);
 ...
 *******************************************************************************/
void					split_after_expantion(t_shell_control_block *sh,
							char *str, char *old_str);
void					expand_and_split_helper(t_shell_control_block *sh,
							int index);
...
void					create_heredoc(t_shell_control_block *s,
							t_token *tokenze);
...
void					process_redirection_token(t_shell_control_block *sh,
							char **ptr);
...
void					handle_expansion_result(t_shell_control_block *sh,
...
void					ft_init_shell_block(t_shell_control_block *sh, int ac,
							char **av);
